...
class NPTFScan(ConfigMaps):
    ...
    def make_ll(self):
        ...
        for i in range(self.nexp):
            ...
            #print('marker')
            #print(theta_ps_expreg[0][1],theta_ps_expreg[0][2])
            
            #print('marker2')
            

            # Change variables from[N, n1, n2, ST] to [A, n1, n2, Sb]
            I1 = 1/(theta_ps_expreg[0][1]-1) + 1/(1-theta_ps_expreg[0][2])
            I2 = 1/(theta_ps_expreg[0][1]-2) + 1/(2-theta_ps_expreg[0][2])
            
            #I3 = 1/(theta_ps_expreg[1][1]-1) + 1/(1-theta_ps_expreg[1][2])
            #I4 = 1/(theta_ps_expreg[1][1]-2) + 1/(2-theta_ps_expreg[1][2])
            
            #print(theta_ps_expreg[0][0],theta_ps_expreg[0][3])
            #Sbcov=(theta_ps_expreg[0][3] / theta_ps_expreg[0][0]) * (I1/I2)
            #print(Sbcov)
            
            #theta_ps_expreg[0][3]=Sbcov
            ...
            # ST -> Sb
            theta_ps_expreg[0][3] = (theta_ps_expreg[0][3] / theta_ps_expreg[0][0]) * (I1/I2)
            #theta_ps_expreg[1][3] = (theta_ps_expreg[1][3] / theta_ps_expreg[1][0]) * (I3/I4)
            
            #print('marker5')
            
            # N -> A
            theta_ps_expreg[0][0] = theta_ps_expreg[0][0] / (theta_ps_expreg[0][3] * I1)
            #theta_ps_expreg[1][0] = theta_ps_expreg[1][0] / (theta_ps_expreg[1][3] * I3)
